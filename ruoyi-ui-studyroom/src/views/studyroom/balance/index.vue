<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button type="primary" plain icon="el-icon-plus" size="mini" @click="handleAdd"
          v-hasPermi="['studyroom:balance:add']">新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="success" plain icon="el-icon-edit" size="mini" :disabled="single" @click="handleUpdate"
          v-hasPermi="['studyroom:balance:edit']">修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="danger" plain icon="el-icon-delete" size="mini" :disabled="multiple" @click="handleDelete"
          v-hasPermi="['studyroom:balance:remove']">删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="warning" plain icon="el-icon-download" size="mini" @click="handleExport"
          v-hasPermi="['studyroom:balance:export']">导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="balanceList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="余额" align="center" prop="balance" min-width="100" :show-overflow-tooltip="true" />
...
列表 */
      ...
      handleDelete(row) {
        ...
        this.$modal.confirm('是否确认删除余额编号为 "' + ids + '"的数据项？ ').then(() => {
          this.loading = true;
      ...
      /** 导出按钮操作 */
      handleExport() {
        this.download('studyroom/balance/export', {
          ...this.queryParams
